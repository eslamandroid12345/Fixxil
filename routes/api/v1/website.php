...
use App\Http\Controllers\Api\V1\App\Structure\MobileLinkController;
use App\Http\Controllers\Api\V1\App\Structure\SeoController;
use App\Http\Controllers\Api\V1\App\Structure\UsesController;
...
use App\Http\Controllers\Api\V1\App\CustomerReview\CustomerReviewController;
    ...
    Route::group(['controller' => UserController::class], function () {
        ...
        Route::group(['prefix' => 'update'], function () {
            Route::group(['prefix' => 'user'], function () {
                ...
                Route::post('documentation', 'storeDocumentation');
            });
        });
    });
});
...
Route::get('sub-categories/{id}/main',[CategoryController::class,'getMainCategoryFromSub']);
...
Route::get('subcategories/{id}', [CategoryController::class, 'getAllSubCategoryForCategory']);
...
Route::get('getBlogsForHome', [BlogController::class, 'getBlogsForHome']);
...
Route::get('search/cities', [CityController::class,'getAllCitiesForSearch']);
...
Route::post('search', [UserHomeController::class,'search']);
...
Route::group(['prefix' => 'structures'], function () {
    ...
    Route::resource('mobile_link', MobileLinkController::class)->only('index');
