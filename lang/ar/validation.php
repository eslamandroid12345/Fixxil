...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'fixed_services.*.name' => 'اسم الخدمة (:position)',
        'fixed_services.*.price' => 'السعر (:position)',
        'fixed_services.*.unit_id' => 'الوحده (:position)',
        ...
        'category_id'   => 'الفئه الرئيسيه ',
        'national_id_image' => 'صوره البطاقه',
        'criminal_record_sheet' => 'صوره الفيش الجنائى',
        'services' => 'الخدمات',
        'cities' => 'المدن',
        'fixed_services' => 'الخدمات الثابته',
        'services_images' => 'صور الخدمات',
        'about' => 'نبذه',
        'question_en' => 'السؤال بالانجليزيه',
        'question_ar' => 'السؤال بالعربيه',
        'permissions' => 'الصلاحيات',
        'point_counter' => 'عدد النقاط',
    ],
