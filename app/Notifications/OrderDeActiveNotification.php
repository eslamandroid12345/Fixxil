...
class OrderDeActiveNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toDatabase(): array
    {
        return [
            'en' => [
                'title' => 'Your order have been de active by managers',
                'order_id' => (string)$this->paramters['order_id'] ?? null
            ],
            'ar' => [
                'title' => 'تم إالغاء تفعيل طلبكم من قبل الاداره',
                'order_id' => (string)$this->paramters['order_id'] ?? null
            ],
        ];
    }
